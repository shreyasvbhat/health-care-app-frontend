        ...
        <div className='px-[5vw] py-4 flex flex-col gap-4'>
            <div className='flex justify-between'>
                <div className='flex gap-5 items-center'>
                    <img className='w-12 cursor-pointer border-[1px] border-black rounded-[50%]' src={info.imgSrc} alt="" />
                    <h2 className='font-semibold text-xl cursor-pointer hover:text-blue-700 transition-all duration-300'>{info.usersName}</h2>
                </div>
                ...
                <div className='flex flex-col items-end gap-1'>
                    ...
                    <p className='text-gray-500'>{info.number} {info.datetime} ago</p>
                </div>
            </div>
